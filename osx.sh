...
# sudo scutil --set ComputerName "foundation"
# sudo scutil --set HostName "foundation"
# sudo scutil --set LocalHostName "foundation"
# sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "foundation"
...
# Accessility reduce transparency
...
defaults write NSGlobalDomain AppleLanguages -array "en" "et" "ru"
